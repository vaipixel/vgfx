...
ResourceCache::ResourceCache(vgfx::Context *context) : context(context), maxBytes(DefaultMaxBytes) {
...
bool ResourceCache::InList(const std::list<Resource *> &list, vgfx::Resource *resource) {
